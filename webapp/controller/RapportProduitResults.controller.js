sap.ui.define([
    ...
    return Controller.extend("project1.controller.RapportProduitResults", {
        onInit: function () {
            const oRouter = sap.ui.core.UIComponent.getRouterFor(this);
            console.log("oRouter:", oRouter);
            oRouter.getRoute("rapportproduit").attachPatternMatched(this._onRouteMatched, this);
        },
        ...
        _onRouteMatched: function (oEvent) {
            ...
            const oSmartTable = this.byId("smartTableRapportProduit");
    ...
    const sPath = `/YPG_PRODUIT_CDS(p_start=datetime'${sStart}T00:00:00',p_end=datetime'${sEnd}T00:00:00')/Set`;

    // Apply the path manually to the SmartTable
    const oSmartTable = this.getView().byId("smartTableRapportProduit");
