sap.ui.define([
    ...
    return Controller.extend("project1.controller.product_copy", {
        formatter: formatter,
        ...
        onSearch: function (oEvent) {
            ...
            if (sQuery && sQuery.length > 0) {
                var oFilter = new sap.ui.model.Filter("NomBac", sap.ui.model.FilterOperator.Contains, sQuery);
