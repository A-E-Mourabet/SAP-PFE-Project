sap.ui.define([
  ...
  return Controller.extend("project1.controller.RapportProduitFilter", {
    onAfficherRapport: function () {
      const oView = this.getView();
      const oStartDate = oView.byId("idDateStartP").getDateValue();
      const oEndDate = oView.byId("idDateEndP").getDateValue();
      ...
      this.getOwnerComponent().getRouter().navTo("rapportproduit", {
